...
class ThingFilter(django_filters.FilterSet):
    date_lte = django_filters.DateFilter(field_name='date_published', lookup_expr='lte')
    date_gte = django_filters.DateFilter(field_name='date_published', lookup_expr='gte')
